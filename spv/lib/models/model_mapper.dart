...
class Mapper {
  ...
  static List<view.CalendarPhase> _mapPhasesToCalendarPhases(
      ...
      phases
          .map((phase) => (view.CalendarPhaseBuilder()
                ...
                ..matchDays = ListBuilder(
                    _mapToMatchDays(phase.matchDays, phase.currentMatchDay)))
              .build())
          .toList();
  ...
  static List<view.Match> _mapToMatches(BuiltList<network.Match> matches) =>
      matches
  ...
  static view.TeamBuilder _mapToTeam(network.Team team) => view.TeamBuilder()
    ...
    ..isFavorite = false
    ..canBeFavourite = team.canSelectAsFavourite;
  ...
  static List<R> _mapListOfTtoR<T, R>(List<T> list, [R mapFunc(T t)]) =>
