...
import 'package:ui_spv/src/calendar/match_day_row.dart';
import 'package:ui_spv/src/calendar/match_end_spacer.dart';
import 'package:ui_spv/src/calendar/match_item_row.dart';
  ...
  Widget build(BuildContext context) {
    if (calendar is Data<Calendar>) {
      ...
      List<MatchDay> matchDays =
          (calendar as Data<Calendar>).value.phases.expand((phase) => phase.matchDays).toList();
