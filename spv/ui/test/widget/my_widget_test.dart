...
class MyWidgetBloc extends BlocEventStateBase<MyEvent, MyState> {
  @override
  Stream<MyState> eventHandler(MyEvent event, MyState currentState) {
    return null;
  }
}
...
void main() {
  ...
  testWidgets('MyWidget has a title and message', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(BlocProvider<MyWidgetBloc>(
      child: MyWidget(title: 'T', message: 'M'),
      bloc: MyWidgetBloc(),
    ));
